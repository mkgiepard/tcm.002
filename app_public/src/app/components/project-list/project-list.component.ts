...
const ELEMENT_DATA: Project[] = [
  ...
  {name: 'Project I', subtitle: 'Regression tests', status: 'Active', author: 'Connan Barbarian', create_date: '2019.11.12'},
  {name: 'Project J', subtitle: 'Regression tests', status: 'Active', author: 'Connan Barbarian', create_date: '2019.11.12'},
  {name: 'Project K', subtitle: 'Regression tests', status: 'Active', author: 'Jon Snow', create_date: '2019.11.12'},
